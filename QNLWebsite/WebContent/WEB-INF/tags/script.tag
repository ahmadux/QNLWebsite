...
<% if(alsoInclude.toLowerCase().contains("bootstrap")) {%><link rel="stylesheet" href="http://localhost:8080/QNLWebsite/css/bootstrap.min.css" />
<script src="http://localhost:8080/QNLWebsite/scripts/bootstrap.min.js"></script><%} %>
<% if(alsoInclude.toLowerCase().contains("slidr")) {%><script src="http://localhost:8080/QNLWebsite/scripts/slidr.js"></script><%} %>
