...
<script src="../scripts/fupload.js"></script>
<link href="../css/qnl2.css" rel="stylesheet" />
</head>

<body>
	<div class="col-xs-12 col-md-3 img-rounded semitransparent pull-left">		
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-default" data-dismiss="modal" onclick="clearSelectionList();">Close Me</button>
  ...
  <div class="modal fade col-xs-7" id="selectionAttributeModal" tabIndex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true" style="overflow:hidden">
   ...
   <div class="modal fade col-xs-7" id="alertModal" tabIndex="-1" role="dialog" aria-hidden="true" style="overflow:hidden">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
