...
<div class="body_slider active  col-xs-12 landing pull-left ">
	<div id="main_content">
		<div class="background_full" style="background-image: url(${BaseServerPath}/images/large/main3.jpg);"></div>
			<div class="row pull-left">
				<div class="sectionBox col-xs-12 col-md-2 col-md-offset-1 img-rounded highSpaceTop pull-left">						
