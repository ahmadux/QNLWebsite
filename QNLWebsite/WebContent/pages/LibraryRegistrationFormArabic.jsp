   ...
   <label class="col-xs-3 control-label"> عدد المطبوعات </label>
            ...
            <div class="form-group">
                 ...
                 <div class="col-xs-9">
                           ...
                           <div class="col-xs-6 heading" style="text-align: center">المسمى   الوظيفي</div>
                           <div class="col-xs-6 heading" style="text-align: center">الاسم</div>
                        <div class="col-xs-6">
                        <input type="text" name="contactTitle1" id="contactTitle1" class="form-control" size="30" maxlength="50" dir="rtl" lang="ar"> </div>
                        <div class="col-xs-6">
                        <input type="text" name="contactName1" id="contactName1" class="form-control" size="29" maxlength="35" dir="rtl" lang="ar"></div>
                        <div class="col-xs-6">
                        <input type="text" name="contactTitle2" id="contactTitle2" class="form-control" size="30" maxlength="50" dir="rtl" lang="ar"> </div>
                        <div class="col-xs-6">
                        <input type="text" name="contactName2" id="contactName2" class="form-control" size="29" maxlength="35" dir="rtl" lang="ar" ></div>
                        <div class="col-xs-6">
                        <input type="text" name="contactTitle3" id="contactTitle3" class="form-control" size="30" maxlength="50" dir="rtl" lang="ar"> </div>
                        <div class="col-xs-6">
                        <input type="text" name="contactName3" id="contactName3" class="form-control" size="29" maxlength="35" dir="rtl" lang="ar" ></div>
...
</div> <label class="col-xs-3 control-label">ابرز الخدمات<font class="helpText">مثال: خدمة الإعارة بين المكتبات، خدمة وايرلس، الكتب الإلكترونية... إلخ</font></label>
           </div>
           
    <div class="form-group">
             
                <div class="col-xs-9">
               			 <div class="col-xs-6 heading" style="text-align: center">الأيام</div>
                          <div class="col-xs-6 heading" style="text-align: center">الوقت</div>
                       
                           <div class="col-xs-3 heading" style="text-align: center">من</div>
                            <div class="col-xs-3 heading" style="text-align: center">إلى</div>
                           <div class="col-xs-3 heading" style="text-align: center">من</div>
                           <div class="col-xs-3 heading" style="text-align: center">إلى</div>
                        <div class="col-xs-3" ><select name="day1F" id="day1F" style="width:120px" class="form-control">
                            ...
                            <div class="col-xs-3" ><select name="day1T" id="day1T" style="width:120px" class="form-control">
                            <option value=""> 				اختر من القائمة 				</option>
                            <option value="السبت"> 				السبت 				</option>
                            <option value="الأحد"> 				الأحد 				</option>
                            <option value="الإثنين"> 				الإثنين 				</option>
                            ...
                            <div class="col-xs-3" ><select name="time1F" id="time1F" style="width:120px" class="form-control">
                            <option value=""> 				اختر من القائمة 				</option>
                            ...
                            <div class="col-xs-3" ><select name="time1T" id="time1T" style="width:120px" class="form-control">
                            <option value=""> 				اختر من القائمة 				</option>
                            <option value="06:00 صباحاً">06:00 صباحاً</option>
                            <option value="06:30 صباحاً">06:30 صباحاً</option>
                            <option value="07:00 صباحاً">07:00 صباحاً</option>
                        ...
                        <div class="col-xs-3" ><select name="day2F" id="day2F" style="width:120px" class="form-control">
                            <option value=""> 				اختر من القائمة 				</option>
                            <option value="السبت"> 				السبت 				</option>
                            <option value="الأحد"> 				الأحد 				</option>
                            <option value="الإثنين"> 				الإثنين 				</option>
                            ...
                            <div class="col-xs-3" ><select name="day2T" id="day2T" style="width:120px" class="form-control">
                            <option value=""> 				اختر من القائمة 				</option>
                            <option value="السبت"> 				السبت 				</option>
                            <option value="الأحد"> 				الأحد 				</option>
                            <option value="الإثنين"> 				الإثنين 				</option>
                            ...
                            <div class="col-xs-3" ><select name="time2F" id="time2F" style="width:120px" class="form-control">
                            <option value="" > 				اختر من القائمة 				</option>
                            <option value="06:00 صباحاً">06:00 صباحاً</option>
                            <option value="06:30 صباحاً">06:30 صباحاً</option>
                            <option value="07:00 صباحاً">07:00 صباحاً</option>
                            ...
                            <div class="col-xs-3" ><select name="time2T" id="time2T" style="width:120px" class="form-control">
                            <option value=""> 				اختر من القائمة 				</option>
                            <option value="06:00 صباحاً">06:00 صباحاً</option>
                            <option value="06:30 صباحاً">06:30 صباحاً</option>
                            <option value="07:00 صباحاً">07:00 صباحاً</option>
                        ...
                        <div class="col-xs-3" ><select name="day3F" id="day3F" style="width:120px" class="form-control">
                            <option value=""> 				اختر من القائمة 				</option>
                            <option value="السبت"> 				السبت 				</option>
                            <option value="الأحد"> 				الأحد 				</option>
                            <option value="الإثنين"> 				الإثنين 				</option>
                            ...
                            <div class="col-xs-3" ><select name="day3T" id="day3T" style="width:120px" class="form-control">
                            <option value="" > 				اختر من القائمة 				</option>
                            <option value="السبت"> 				السبت 				</option>
                            <option value="الأحد"> 				الأحد 				</option>
                            <option value="الإثنين"> 				الإثنين 				</option>
                            ...
                            <div class="col-xs-3" ><select name="time3F" id="time3F" style="width:120px" class="form-control">
                            <option value="" > 				اختر من القائمة 				</option>
                            <option value="06:00 صباحاً">06:00 صباحاً</option>
                            <option value="06:30 صباحاً">06:30 صباحاً</option>
                            <option value="07:00 صباحاً">07:00 صباحاً</option>
                            ...
                            <div class="col-xs-3" ><select name="time3T" id="time3T" style="width:120px" class="form-control">
                            <option value="" > 				اختر من القائمة 				</option>
                            <option value="06:00 صباحاً">06:00 صباحاً</option>
                            <option value="06:30 صباحاً">06:30 صباحاً</option>
                            <option value="07:00 صباحاً">07:00 صباحاً</option>
                       ...
                       <div class="col-xs-3" > <select name="day4F" id="day4F" style="width:120px" class="form-control">
                            <option value=""> 				اختر من القائمة 				</option>
                            <option value="السبت"> 				السبت 				</option>
                            <option value="الأحد"> 				الأحد 				</option>
                            <option value="الإثنين"> 				الإثنين 				</option>
                            ...
                            <div class="col-xs-3" ><select name="day4T" id="day4T" style="width:120px" class="form-control">
                            <option value=""> 				اختر من القائمة 				</option>
                            <option value="السبت"> 				السبت 				</option>
                            <option value="الأحد"> 				الأحد 				</option>
                            <option value="الإثنين"> 				الإثنين 				</option>
                            ...
                            <div class="col-xs-3" ><select name="time4F" id="time4F" style="width:120px" class="form-control">
                            <option value=""> 				اختر من القائمة 				</option>
                            <option value="06:00 صباحاً">06:00 صباحاً</option>
                            <option value="06:30 صباحاً">06:30 صباحاً</option>
                            <option value="07:00 صباحاً">07:00 صباحاً</option>
                            ...
                            <div class="col-xs-3" ><select name="time4T" id="time4T" style="width:120px" class="form-control">
                            <option value="" > 				اختر من القائمة 				</option>
                            <option value="06:00 صباحاً">06:00 صباحاً</option>
                            <option value="06:30 صباحاً">06:30 صباحاً</option>
                            <option value="07:00 صباحاً">07:00 صباحاً</option>
